...
<body style="margin: 0">
  <div id="content" >
    <img src="/graduate100/graduate/Public/img/4-8.png" style="height: 100%;width: 100%;margin: 0;padding: 0;position: absolute;"> 
    ...
    <div id="Home">
      ...
      <div id="name">
        <img src="/graduate100/graduate/Public/img/4-1.png" style="margin: 0 auto;max-width:100%;max-height:100% ">
      </div>
      ...
      <div id="code">
        <img src="/graduate100/graduate/Public/img/code.png" style="width:100%">
      </div>
      <div id="sodoi">
    ...
    <!-- <div id="content1"> -->
    <div id="result" style="position:absolute;z-index:40;">
...
img.onload=function(){ //将选出的图片排版
  ...
  // 先将能排满的行排好
    ...
    for(var i = 0,j = 0 ;j < _l ; i++){
      ...
      var textheight = (i+1)*imgwidth+marginheight+35*i;
      canvas.drawImage(imglist[j].picture, imgwidth*(0+0.025)+marginwidth,i*imgwidth+marginheight+35*i,imgwidth*0.95,imgwidth*0.95);
      canvas.fillText(imglist[j++].s,0.5*imgwidth+marginwidth,textheight);    
      canvas.drawImage(imglist[j].picture, imgwidth*(1+0.025)+marginwidth,i*imgwidth+marginheight+35*i,imgwidth*0.95,imgwidth*0.95); 
      canvas.fillText(imglist[j++].s, 1.5*imgwidth+marginwidth,textheight);
      canvas.drawImage(imglist[j].picture, imgwidth*(2+0.025)+marginwidth,i*imgwidth+marginheight+35*i,imgwidth*0.95,imgwidth*0.95); 
      canvas.fillText(imglist[j++].s, 2.5*imgwidth+marginwidth,textheight);
    }
    if(row > 0){
      ...
      //余出来的单排
        ...
        canvas.drawImage(imglist[j].picture,imgwidth*(i+0.025)+marginwidth,row*(imgwidth)+marginheight+row*35,imgwidth*0.95,imgwidth*0.95);  
        canvas.fillText(imglist[j++].s, imgwidth*(i+0.5)+marginwidth,(row+1)*imgwidth+marginheight+35*row,imgwidth);
      }
    }  
  }
  htmltocanvas();
...
html2canvas(document.body,{scale:1,scrollY:0,scrollX:0,}).then(canvas =>{
